...
The same directory also contains the compressed PAF files and all output files generated by the run, including filter reports, chromosome correspondence tables, SV summaries, filtered blocks, and ASA reports.
